...
- [x] Adena research notes  
- [x] Expo TypeScript app shell  
- [x] Network registry (Topaz default)  
- [x] WebGnoClient (create/import/send/call)  
- [x] Browser-safe live balances + multi-asset list  
- [x] English open-source docs + Pages deploy workflow  
